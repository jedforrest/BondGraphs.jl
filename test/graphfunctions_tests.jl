@testmodule GraphFunctions begin
    using Graphs
end


@testitem "BondGraph Properties" setup=[GraphFunctions] begin
    bg = BondGraph("newBG")
    @test name(bg) == "newBG"
...
@testitem "Adding and removing elements" begin
    c = Component(:C)
    r = Component(:R)
    j0 = EqualEffort()
...
@testitem "Graphs.jl Extra Functions" begin
    c1 = Component(:C)
    c2 = Component(:R)
    c3 = Component(:I)
    j = EqualFlow()
